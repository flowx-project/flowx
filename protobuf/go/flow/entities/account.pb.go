...
// source: flowx/entities/account.proto
...
func init() {
	proto.RegisterType((*Account)(nil), "flowx.entities.Account")
	proto.RegisterMapType((map[string][]byte)(nil), "flowx.entities.Account.ContractsEntry")
	proto.RegisterType((*AccountKey)(nil), "flowx.entities.AccountKey")
}

func init() { proto.RegisterFile("flowx/entities/account.proto", fileDescriptor_bf0d6f6360ab9ab0) }
