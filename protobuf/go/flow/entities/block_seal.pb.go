...
// source: flowx/entities/block_seal.proto
...
func init() {
	proto.RegisterType((*BlockSeal)(nil), "flowx.entities.BlockSeal")
}

func init() { proto.RegisterFile("flowx/entities/block_seal.proto", fileDescriptor_e5bc0062689af71f) }
