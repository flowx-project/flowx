...
// source: flowx/entities/block_header.proto
...
func init() {
	proto.RegisterType((*BlockHeader)(nil), "flowx.entities.BlockHeader")
}

func init() { proto.RegisterFile("flowx/entities/block_header.proto", fileDescriptor_b9d8363da0276a74) }
