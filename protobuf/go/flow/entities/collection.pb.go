...
// source: flowx/entities/collection.proto
...
func init() {
	proto.RegisterType((*Collection)(nil), "flowx.entities.Collection")
	proto.RegisterType((*CollectionGuarantee)(nil), "flowx.entities.CollectionGuarantee")
}

func init() { proto.RegisterFile("flowx/entities/collection.proto", fileDescriptor_b302551359ed99bf) }
