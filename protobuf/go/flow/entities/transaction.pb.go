...
// source: flowx/entities/transaction.proto
...
func init() {
	proto.RegisterEnum("flowx.entities.TransactionStatus", TransactionStatus_name, TransactionStatus_value)
	proto.RegisterType((*Transaction)(nil), "flowx.entities.Transaction")
	proto.RegisterType((*Transaction_ProposalKey)(nil), "flowx.entities.Transaction.ProposalKey")
	proto.RegisterType((*Transaction_Signature)(nil), "flowx.entities.Transaction.Signature")
}

func init() { proto.RegisterFile("flowx/entities/transaction.proto", fileDescriptor_84361b1ad2e0936e) }
