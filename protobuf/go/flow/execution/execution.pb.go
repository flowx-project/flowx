...
// source: flowx/execution/execution.proto
...
func init() {
	proto.RegisterType((*PingRequest)(nil), "flowx.execution.PingRequest")
	proto.RegisterType((*PingResponse)(nil), "flowx.execution.PingResponse")
	proto.RegisterType((*GetAccountAtBlockIDRequest)(nil), "flowx.execution.GetAccountAtBlockIDRequest")
	proto.RegisterType((*GetAccountAtBlockIDResponse)(nil), "flowx.execution.GetAccountAtBlockIDResponse")
	proto.RegisterType((*ExecuteScriptAtBlockIDRequest)(nil), "flowx.execution.ExecuteScriptAtBlockIDRequest")
	proto.RegisterType((*ExecuteScriptAtBlockIDResponse)(nil), "flowx.execution.ExecuteScriptAtBlockIDResponse")
	proto.RegisterType((*GetEventsForBlockIDsResponse)(nil), "flowx.execution.GetEventsForBlockIDsResponse")
	proto.RegisterType((*GetEventsForBlockIDsResponse_Result)(nil), "flowx.execution.GetEventsForBlockIDsResponse.Result")
	proto.RegisterType((*GetEventsForBlockIDsRequest)(nil), "flowx.execution.GetEventsForBlockIDsRequest")
	proto.RegisterType((*GetTransactionResultRequest)(nil), "flowx.execution.GetTransactionResultRequest")
	proto.RegisterType((*GetTransactionResultResponse)(nil), "flowx.execution.GetTransactionResultResponse")
}

func init() { proto.RegisterFile("flowx/execution/execution.proto", fileDescriptor_699624211ed46c53) }

var fileDescriptor_699624211ed46c53 = []byte{
	// 572 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *executionAPIClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/flowx.execution.ExecutionAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetAccountAtBlockID(ctx context.Context, in *GetAccountAtBlockIDRequest, opts ...grpc.CallOption) (*GetAccountAtBlockIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/flowx.execution.ExecutionAPI/GetAccountAtBlockID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) ExecuteScriptAtBlockID(ctx context.Context, in *ExecuteScriptAtBlockIDRequest, opts ...grpc.CallOption) (*ExecuteScriptAtBlockIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/flowx.execution.ExecutionAPI/ExecuteScriptAtBlockID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetEventsForBlockIDs(ctx context.Context, in *GetEventsForBlockIDsRequest, opts ...grpc.CallOption) (*GetEventsForBlockIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/flowx.execution.ExecutionAPI/GetEventsForBlockIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionAPIClient) GetTransactionResult(ctx context.Context, in *GetTransactionResultRequest, opts ...grpc.CallOption) (*GetTransactionResultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/flowx.execution.ExecutionAPI/GetTransactionResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ExecutionAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flowx.execution.ExecutionAPI/Ping",
	}
...
func _ExecutionAPI_GetAccountAtBlockID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flowx.execution.ExecutionAPI/GetAccountAtBlockID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_ExecuteScriptAtBlockID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flowx.execution.ExecutionAPI/ExecuteScriptAtBlockID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_GetEventsForBlockIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flowx.execution.ExecutionAPI/GetEventsForBlockIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExecutionAPI_GetTransactionResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flowx.execution.ExecutionAPI/GetTransactionResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ExecutionAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "flowx.execution.ExecutionAPI",
	...
	Metadata: "flowx/execution/execution.proto",
}
